...
### Onde o código encontra a vida.

**Biologia + Computação + Dados + Saúde**

![Python](https://img.shields.io/badge/Python-Computação-00B8D9?logo=python&logoColor=white)
![Bioinformática](https://img.shields.io/badge/Bioinformática-Dados%20Biológicos-34D399)
![Jupyter](https://img.shields.io/badge/Google%20Colab-Prática-F9AB00?logo=googlecolab&logoColor=white)
![Ensino](https://img.shields.io/badge/Ensino-Aprender%20fazendo-A3E635)
...
### Página inicial e Quiz Revisão 1

➡️ [Abrir o guia da disciplina](https://deniaulainfead23.github.io/bioinformatica/)  
➡️ [Ir direto ao Quiz Revisão 1](https://deniaulainfead23.github.io/bioinformatica/revisao/Quiz_Tecnologia_Saude_Bioinformatica.html)  
➡️ [Abrir o resumo por tópicos](https://deniaulainfead23.github.io/bioinformatica/revisao/)

Para disponibilizar o site, em **Settings → Pages**, selecione **Deploy from a branch**, escolha **main** e **/(root)** e salve.
...
|---|---|
| [NCBI](https://www.ncbi.nlm.nih.gov/) | Portal de recursos biológicos e biomédicos |
| [GenBank](https://www.ncbi.nlm.nih.gov/genbank/) | Sequências de nucleotídeos |
...
### `ATCG` + `Python` → Bioinformática

**🧬 vida | dados | algoritmos `</>`**
